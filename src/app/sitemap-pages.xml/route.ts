...
export async function GET() {
  ...
  const staticPaths: SitemapEntry[] = [
    ...
    { path: "/blog/ia-entreprise", changefreq: "weekly", priority: "0.9", lastmod: today },
    { path: "/blog/ia-education", changefreq: "weekly", priority: "0.9", lastmod: today },
    { path: "/services/scraping-intelligent", changefreq: "weekly", priority: "0.8", lastmod: today },
    { path: "/services/audit-gratuit", changefreq: "weekly", priority: "0.9", lastmod: today },
    { path: "/services/analyse-semantique-nlp", changefreq: "weekly", priority: "0.9", lastmod: today },
    { path: "/services/data-engineering", changefreq: "weekly", priority: "0.9", lastmod: today },
    { path: "/services/developpement-api", changefreq: "weekly", priority: "0.9", lastmod: today },
