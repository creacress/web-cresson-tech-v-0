...
<main className="px-6 pt-24 pb-16 text-white max-w-6xl mx-auto">
  ...
  <section className="my-16">
    <h2 className="text-3xl font-bold text-center mb-2">Packs GénAI pour PME</h2>
    <p className="text-gray-400 text-center mb-8">Lancez‑vous sans friction. Évolutif ensuite.</p>
    <div className="grid md:grid-cols-3 gap-6">
      {[ 
        { name: 'GenAI Starter', price: 1290, sku: 'genai-starter', features: ['Gabarits de contenu', 'Images + textes', "Workflow d'approbation", 'Formation 2h'], url: '/services/intelligence-artificielle' },
        { name: 'GenAI Growth', price: 2490, sku: 'genai-growth', features: ['10 gabarits SEO', 'Assistant IA basique', 'Automations e‑mail', 'Tableau de bord ROI'], url: '/services/intelligence-artificielle' },
        { name: 'GenAI Pro', price: 3990, sku: 'genai-pro', features: ['Assistant IA avancé', 'Fine‑tuning léger', 'Intégrations CRM/ERP', 'Atelier équipes'], url: '/services/intelligence-artificielle' },
      ].map((p, i) => (
        <div key={i} className="group relative">
  ...
  <script
    ...
    dangerouslySetInnerHTML={{
      __html: JSON.stringify({
        ...
        offerCount: 3,
        offers: [
          { '@type': 'Offer', price: 1290, priceCurrency: 'EUR', url: 'https://webcresson.com/services/intelligence-artificielle?plan=genai-starter', availability: 'https://schema.org/InStock' },
          { '@type': 'Offer', price: 2490, priceCurrency: 'EUR', url: 'https://webcresson.com/services/intelligence-artificielle?plan=genai-growth', availability: 'https://schema.org/InStock' },
          { '@type': 'Offer', price: 3990, priceCurrency: 'EUR', url: 'https://webcresson.com/services/intelligence-artificielle?plan=genai-pro', availability: 'https://schema.org/InStock' },
        ],
      }),
    }}
  />
  ...
  <section className="my-16 bg-[#0b0b0b] rounded-xl border border-[#00e0ff22] p-8 text-center">
    <h2 className="text-3xl font-bold mb-8">Impact mesurable de la GénAI</h2>
    <div className="grid grid-cols-1 sm:grid-cols-3 gap-8 text-white">
      <div>
        <p className="text-5xl font-extrabold text-[#00e0ff]">x4</p>
        <p className="text-gray-400">Vitesse de production</p>
      </div>
      <div>
        <p className="text-5xl font-extrabold text-[#00e0ff]">-60%</p>
        <p className="text-gray-400">Temps passé sur contenus</p>
      </div>
      <div>
        <p className="text-5xl font-extrabold text-[#00e0ff]">+30%</p>
        <p className="text-gray-400">Leads/Conversion</p>
      </div>
    </div>
  </section>
