...
export default function Home() {
  ...
  <section className="py-20 bg-black text-white">
    <div className="container mx-auto px-4 text-center">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
        {SolutionsSection.map((sol, i) => (
          <div
            key={i}
            className="bg-zinc-900 p-6 rounded-xl shadow-lg hover:scale-[1.02] transition flex flex-col items-center"
          >
            {sol.icon}
    ...
    <CiblesSection />
        {/* Glossaire IA */}
        <section className="py-16 px-4 md:px-12 bg-zinc-950 text-white">
      <h2 className="text-3xl md:text-4xl font-bold mb-8 text-center">Glossaire</h2>
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-4xl mx-auto">
        {glossaire.map(({ terme, definition }, i) => (
          <div key={i} className="border border-zinc-800 rounded-lg p-6 hover:bg-zinc-900 transition">
            <h3 className="text-xl font-semibold mb-2 text-indigo-400">{terme}</h3>
